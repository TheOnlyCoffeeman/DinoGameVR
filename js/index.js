...
engine.registerComponent(ButtonLbToggle);
engine.registerComponent(ButtonStart);
engine.registerComponent(ButtonYt);
engine.registerComponent(Button);
engine.registerComponent(LeaderboardComponent);
engine.registerComponent(Obstacle);
engine.registerComponent(PlayerControl);
engine.registerComponent(SkyAnimation);
